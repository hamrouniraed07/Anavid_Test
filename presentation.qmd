...
- **Gradient Boosting emerges as the best performing model with the highest F1 score**
...
- Gradient Boosting's sequential learning approach effectively captures complex patterns in the data
...
- **Gradient Boosting is the best performing model with the highest F1 score**
- All three models demonstrate competitive performance, but Gradient Boosting excels in capturing complex relationships
- Feature importance analysis reveals key predictors across models
